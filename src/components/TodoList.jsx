          ...
          <tbody>
            {todos.map((todo, index) => (
              ...
              >
                ...
                <td className="border border-slate-400 px-4 py-2">{todo.todoTask}</td>
                <td className="border border-slate-400 px-4 py-2 text-center">
                  {todo.status}
                </td>
                <td className="border border-slate-400 px-4 py-2 text-center">
                  <button className="px-3 py-1 bg-blue-500 text-white rounded hover:bg-blue-600" onClick={() => onComplete(todo.id) }>
                    Completed
                  </button>{" "}
                  <button className="px-3 py-1 bg-red-500 text-white rounded hover:bg-red-600" onClick={() => onDelete(todo.id) }>
                    Delete
                  </button>
                </td>
              </tr>
